...
import com.buyer.steelhub.utility.NotificationUtils;
import com.buyer.steelhub.utility.ServiceApi;
import com.buyer.steelhub.view.activity.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleNotification(String message) {
        if (MainActivity.instance == null) {
            ...
            Intent pushNotification = new Intent(ServiceApi.PUSH_NOTIFICATION);
    ...
    public static void showNotificationDialog(String msg) {
        ...
        final AlertDialog.Builder altDialog = new AlertDialog.Builder(MainActivity.instance);
